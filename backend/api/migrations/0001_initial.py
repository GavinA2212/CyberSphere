    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discountprice', models.IntegerField(blank=True, default=models.FloatField(), null=True)),
                ...
                ('featured', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.productfeatured')),
            ],
            options={
                'abstract': False,
            },
