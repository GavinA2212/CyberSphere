...
export default function MainShowcase() {
  return (
    <>
      <div className="flex min-h-sixtytwop w-seventyp  gap-0  border-blue-500 xs:flex-col md:mt-14 md:flex-row md:gap-12">
        <div className="mt-1 h-fit min-h-sixtytwop w-full flex-col   border-red-500 md:mt-16 md:w-2/5">
